        ...
        <div className="body_content">
                    ...
                    <div className="mb30">
                      <div className="main-title">
                        <h2 className="title">
                          ...
                          <br className="d-none d-md-block" /> talent at your
                          fingertips
                        </h2>
                      </div>
                    </div>
                      ...
                      <div className="list-one d-flex align-items-start mb30">
                        ...
                        <div className="list-content flex-grow-1 ml20">
                          ...
                          <p className="text mb-0 fz15">
                            ...
                            rates, and only pay{" "}
                            <br className="d-none d-lg-block" /> for work you
                            approve.
                          </p>
                        </div>
                      </div>
                      <div className="list-one d-flex align-items-start mb30">
                        ...
                        <div className="list-content flex-grow-1 ml20">
                          ...
                          <p className="text mb-0 fz15">
                            ...
                            and privacy. We’re here with 24/7 support if you
                            need it.
                          </p>
                        </div>
                      </div>
          ...
          <section className="pb80 pb50-md">
            <div className="container">
              ...
              <div className="row wow fadeInUp" data-wow-delay="300ms">
                <div className="col-lg-12">
                  <div className="navi_pagi_top_right slider-5-grid owl-carousel owl-theme">
                    <div className="item">
