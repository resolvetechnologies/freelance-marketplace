              ...
              <div className="row wow fadeInUp">
                ...
                <div className="col-lg-9">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12">
                      <div className="service-v5-slider slider-dib-sm navi_pagi_top_right slider-3-grid owl-carousel owl-theme mb30">
                        <div className="item">
                    ...
                    <div className="col-md-6">
                      <div className="text-center text-md-start">
                        <p className="text mb-0 mb10-sm">
                          <span className="fw500">5,512</span> services
                          available
                        </p>
                      </div>
                    </div>
