                  ...
                  <div class="text-center text-lg-start d-flex align-items-center">
                    <div class="dashboard_header_logo position-relative me-2 me-xl-5">
                      <a href="index.html" class="logo">
                        <img src="images/header-logo-dark.svg" alt=""></img>
                      </a>
                    </div>
                    <div class="fz20 ml90">
                      <a href="#" class="dashboard_sidebar_toggle_icon vam">
                        <img src="images/dashboard-navicon.svg" alt=""></img>
                      </a>
                    </div>
                    <a
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <div class="user_setting_content">
                              <p class="fz15 fw400 ff-heading mb10 pl30">
                                Start
                              </p>
                              <a
                                class="dropdown-item"
                              ...
                              >
                                <i class="flaticon-briefcase mr10"></i>Manage
                                Jobs
                              </a>
                              <a
                                class="dropdown-item"
              ...
              <div class="menu_and_widgets">
                <div class="mobile_menu_bar d-flex justify-content-between align-items-center">
                  <a class="mobile_logo" href="#">
                    <img src="images/header-logo3.svg" alt=""></img>
                  </a>
                  <div class="right-side text-end">
                    ...
                    <a class="menubar ml30" href="#menu">
                      <img src="images/mobile-dark-nav-icon.svg" alt=""></img>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="dashboard__sidebar d-none d-lg-block">
              <div class="dashboard_sidebar_list">
                ...
                <div class="sidebar_list_item">
                  <a href="page-dashboard.html" class="items-center">
                    <i class="flaticon-home mr15"></i>Dashboard
                  </a>
                </div>
                <div class="sidebar_list_item">
                  <a href="page-dashboard-proposal.html" class="items-center">
                ...
                <div class="sidebar_list_item ">
                  <a href="page-dashboard-reviews.html" class="items-center">
                    <i class="flaticon-review-1 mr15"></i>Reviews
                  </a>
                </div>
                <div class="sidebar_list_item">
                  <a href="page-dashboard-invoice.html" class="items-center">
                    <i class="flaticon-receipt mr15"></i>Invoice
                  </a>
                </div>
                <div class="sidebar_list_item">
                  <a href="page-dashboard-payouts.html" class="items-center">
                ...
                <p class="fz15 fw400 ff-heading pl30 mt30">
                  Organize and Manage
                </p>
                <div class="sidebar_list_item ">
                  <a
                ...
                <div class="sidebar_list_item ">
                  <a href="page-dashboard-profile.html" class="items-center">
                                ...
                                <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                                  <div class="d-lg-flex align-items-lg-center">
                                    ...
                                    <div class="details ml15 ml0-md mb15-md">
                                      ...
                                      <h6 class="mb-0 text-thm">Mailchimp</h6>
                                    </div>
                                  </div>
                                </div>
                              </th>
                              <td class="vam">
                                <span class="fz15 fw400">3+ Applied</span>
                              </td>
                              <td class="vam">
                                <span>October 27, 2017</span>
                                <br></br>
                                <span class="fz14 fw400">April 25, 2011</span>
                              </td>
                              <td class="vam">
                                <span class="pending-style style6">Active</span>
                              </td>
                              <td>
                                <div class="d-flex">
                                  <a
