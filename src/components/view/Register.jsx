  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="freelance.kaiketsu.tech - Freelance Marketplace"
        />
                  ...
                  <div className="col-auto pe-0">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="home1_style">
                        <div id="mega-menu">
                          <Link className="btn-mega fw500" href="#">
                            <span className="pl30 pl10-xl pr5 fz15 vam flaticon-menu"></span>{" "}
                            Categories
                          </Link>
                          <ul className="menu ps-0">
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-developer"></span>{" "}
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-web-design-1"></span>{" "}
                                <span className="menu-title">
                                  Design & Creative
                                </span>{" "}
                              </Link>
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-digital-marketing"></span>{" "}
                                <span className="menu-title">
                                  Digital Marketing
                                </span>{" "}
                              </Link>
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-translator"></span>{" "}
                                <span className="menu-title">
                                  Writing & Translation
                                </span>{" "}
                              </Link>
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-microphone"></span>{" "}
                                <span className="menu-title">
                                  Music & Audio
                                </span>{" "}
                              </Link>
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-video-file"></span>{" "}
                                <span className="menu-title">
                                  Video & Animation
                                </span>{" "}
                              </Link>
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-ruler"></span>{" "}
                                <span className="menu-title">
                            ...
                            <li>
                              ...
                              <Link className="dropdown" href="#">
                                {" "}
                                <span className="menu-icn flaticon-goal"></span>{" "}
                                <span className="menu-title">
                                  Finance & Accounting
                                </span>{" "}
                              </Link>
                ...
                <div className="menu_and_widgets">
                  <div className="mobile_menu_bar d-flex justify-content-between align-items-center">
                    ...
                    <div className="right-side text-end">
                      <Link className="" href="page-login">
                        join
                      </Link>
                      <Link className="menubar ml30" href="#menu">
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <Link href="/">Home V4</Link>
                    </li>
                    <li>
                      <Link href="/">Home V5</Link>
                    </li>
                    <li>
                      <Link href="/">Home V6</Link>
                    </li>
                    <li>
                      <Link href="/">Home V7</Link>
                    </li>
                    <li>
                      <Link href="/">Home V8</Link>
                    </li>
                    <li>
                      <Link href="/">Home V9</Link>
                    </li>
                    <li>
                      <Link href="/">Home V10</Link>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-service-v1">Service v1</Link>
                        </li>
                        <li>
                          <Link href="./page-service-v2">Service v2</Link>
                        </li>
                        <li>
                          <Link href="./page-service-v3">Service v3</Link>
                        </li>
                        <li>
                          <Link href="./page-service-v4">Service v4</Link>
                        </li>
                        <li>
                          <Link href="./page-service-v5">Service v5</Link>
                        </li>
                        <li>
                          <Link href="./page-service-v6">Service v6</Link>
                        </li>
                        <li>
                          <Link href="./page-service-v7">Service v7</Link>
                        </li>
                        <li>
                          <Link href="./page-service-all">Service All</Link>
                        </li>
                        <li>
                          <Link href="./page-service-single">
                            Service Single
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-project-v1">Project v1</Link>
                        </li>
                        <li>
                          <Link href="./page-project-single">
                            Project Single
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-job-list-v1">Job list v1</Link>
                        </li>
                        <li>
                          <Link href="./page-job-list-v2">Job list v2</Link>
                        </li>
                        <li>
                          <Link href="./page-job-list-v3">Job list V3</Link>
                        </li>
                        <li>
                          <Link href="./page-job-list-single">Job Single</Link>
                        </li>
                      </ul>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <Link href="./page-dashboard-proposal">Proposal</Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-save">Saved</Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-message">Message</Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-reviews">Reviews</Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-invoice">Invoice</Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-payouts">Payouts</Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-statement">
                            Statement
                          </Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-manage-service">
                            Manage Service
                          </Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-add-service">
                            Add Services
                          </Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-manage-jobs">
                            Manage Jobs
                          </Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-manage-project">
                            Manage Project
                          </Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-create-project">
                            Create Project
                          </Link>
                        </li>
                        <li>
                          <Link href="./page-dashboard-profile">
                            My Profile
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-employee-v1">Employee V1</Link>
                        </li>
                        <li>
                          <Link href="./page-employee-v2">Employee V2</Link>
                        </li>
                        <li>
                          <Link href="./page-employee-single">
                            Employee Single
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-freelancer-v1">Freelancer V1</Link>
                        </li>
                        <li>
                          <Link href="./page-freelancer-v2">Freelancer V2</Link>
                        </li>
                        <li>
                          <Link href="./page-freelancer-v3">Freelancer V3</Link>
                        </li>
                        <li>
                          <Link href="./page-freelancer-single">
                            Freelancer Single
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li>
                      <Link href="./page-become-seller">Become Seller</Link>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-about">About v1</Link>
                        </li>
                        <li>
                          <Link href="./page-about-v2">About v2</Link>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul>
                        <li>
                          <Link href="./page-shop">List</Link>
                        </li>
                        <li>
                          <Link href="./page-shop-single">Single</Link>
                        </li>
                        <li>
                          <Link href="./page-shop-cart">Cart</Link>
                        </li>
                        <li>
                          <Link href="./page-shop-checkout">Checkout</Link>
                        </li>
                        <li>
                          <Link href="./page-shop-order">Order</Link>
                        </li>
                      </ul>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="./page-invoice">Invoices</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="./page-ui-element">UI Elements</Link>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      <Link href="./page-blog-v1">List V1</Link>
                    </li>
                    <li>
                      <Link href="./page-blog-v2">List V2</Link>
                    </li>
                    <li>
                      <Link href="./page-blog-v3">List V3</Link>
                    </li>
                    <li>
                      <Link href="./page-blog-single">Single</Link>
                    </li>
                  </ul>
                </li>
                  ...
                  >
                    <div className="main-title text-center">
                      ...
                      <p className="paragraph">
                        Register now to discover your next freelance adventure!
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
                      <div className="mb30">
                        ...
                        <p className="text mt20">
                          ...
                          <Link href="./page-login" className="text-thm">
                            Log In!
                          </Link>
                        </p>
                      </div>
                ...
                <div className="row bb-white-light pb10 mb60">
                  <div className="col-md-7">
                    <div className="d-block text-center text-md-start justify-content-center justify-content-md-start d-md-flex align-items-center mb-3 mb-md-0">
                      ...
                      <Link className="fz17 fw500 text-white" href="#">
                        Site Map
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="col-sm-6 col-lg-3">
                    <div className="link-style1 mb-4 mb-sm-5">
                      ...
                      <ul className="ps-0">
                        ...
                        <li>
                          <Link href="#">Selling on Freeio</Link>
                        </li>
                        <li>
                          <Link href="#">Buying on Freeio</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
