                ...
                <div className="row">
                  <div className="col-xl-5">
                    <div className="position-relative">
                      <h2 className="text-white">Freeio Blog</h2>
                    ...
                    <div className="blog-content pl0-sm pl30-lg pl60 py-0 pe-0 flex-grow-1">
                      ...
                      <div className="d-flex mt50 mt30-lg">
                        ...
                        <div className="details ml20">
                          <div className="h6">Leslie Alexander</div>
                          <p className="mb-0">December 2, 2022</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="blog-sidebar ms-lg-auto">
                    ...
                    <div className="sidebar-widget mb30">
                      ...
                      <div className="category-list mt30">
                        ...
                        >
                          Designer{" "}
                          <span className="body-light-color">(1,945)</span>
                        </a>
                        <a
                          className="d-flex align-items-center justify-content-between"
                          href="#"
                        ...
                        >
                          Illustrators{" "}
                          <span className="body-light-color">(917)</span>
                        </a>
                        <a
                          className="d-flex align-items-center justify-content-between"
                          href="#"
                        >
                          Node.js{" "}
                          <span className="body-light-color">(240)</span>
                        </a>
                        <a
                          className="d-flex align-items-center justify-content-between"
                          href="#"
